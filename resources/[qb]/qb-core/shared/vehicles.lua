...
local Vehicles = {
    ...
    { model = 'impaler5',        name = 'Impaler SZ',                    brand = 'Declasse',        price = 175000,  category = 'sedans',         type = 'automobile', shop = 'pdm' },
    --- SUV (2)
    ...
    { model = 'speedo5',         name = 'Speedo Custom',                 brand = 'Vapid',           price = 28000,   category = 'vans',           type = 'automobile', shop = 'pdm' },
