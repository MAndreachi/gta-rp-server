					...
					>
						...
						<div className="flex items-center justify-between border-b border-[#2a2a2a] bg-gradient-to-r from-[#0f0f0f] to-[#1a1a1a] px-6 py-4 rounded-t-lg">
							<div className="flex-1">
								<h2 className="text-2xl font-bold text-white">Towing Job Management</h2>
								{stats && (
								...
								<div className="flex-1 overflow-y-auto p-5 space-y-5">
									...
									<div>
										...
										<div className="space-y-2.5 text-xs text-[#aaa] leading-relaxed">
											<div className="flex gap-2">
												...
												<span>Start a job to rent a flatbed truck ($250 deposit)</span>
											</div>
											<div className="flex gap-2">
												<span className="text-green-400 font-bold flex-shrink-0">2.</span>
												<span>Drive to marked location and use <span className="text-white font-semibold">/tow</span> to hook up vehicle</span>
											</div>
											<div className="flex gap-2">
												<span className="text-green-400 font-bold flex-shrink-0">3.</span>
												<span>Deliver to drop-off location</span>
											</div>
											<div className="flex gap-2">
												<span className="text-green-400 font-bold flex-shrink-0">4.</span>
												<span>Automatically receive new contract</span>
											</div>
											<div className="flex gap-2">
												<span className="text-green-400 font-bold flex-shrink-0">5.</span>
												<span>Collect payslip when ready</span>
											</div>
										</div>
									</div>
									...
									<div className="border-t border-[#2a2a2a] pt-5">
										...
										<div className="space-y-2.5 text-xs text-[#aaa]">
											<div>
												<span className="text-white font-semibold">Base XP:</span> 10 per vehicle
											</div>
											<div>
												<span className="text-white font-semibold">Perfect Delivery:</span> +5 XP (0% damage)
											</div>
											<div>
												<span className="text-white font-semibold">Quick Delivery:</span> +3 XP (&lt;5 min)
											</div>
										</div>
									...
									<div className="border-t border-[#2a2a2a] pt-5">
										...
										<div className="space-y-2 text-xs text-[#aaa]">
											<div className="flex justify-between">
												<span className="text-[#888]">Base Pay:</span>
												<span className="text-white font-semibold">$150-170</span>
											</div>
											<div className="flex justify-between">
												<span className="text-[#888]">Volume Bonus:</span>
												<span className="text-white font-semibold">5+ (5%), 10+ (7%), 15+ (10%), 20+ (12%)</span>
											</div>
											<div className="flex justify-between">
