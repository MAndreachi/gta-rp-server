...
Config.SharedGarages = false       -- true == take any car from any garage | false == only take car from garage stored in (garage-specific storage)
...
Config.TransferCost = 100          -- Cost to transfer a vehicle between garages
